...
function getValuesFromForm(form){
  ...
  sheet.appendRow([Q,name,dep,tel,message]);
   ...
   MailApp.sendEmail({
     ...
     subject: "收到一則回覆",
     htmlBody: "收到一則來自玉花園的意見回覆, <br> 留言人: "+name+" <br>留言內容: "+message +"<br>查看回覆結果:https://docs.google.com/spreadsheets/d/1Qmk5uERi4oW6swAT-P_ysOTTkyDtYaBVEdJiNXUREzU/edit#gid=0 "
   });
}
